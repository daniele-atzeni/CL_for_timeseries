...
# nohup python run_nonorm_w_tuning.py --dataset_name='m4_weekly' --model_choice='feedforward' --ctx='gpu(1)' --n_trials=10 --standardize > nohup_out/current_gpu_ffn_overall_m4w1.out 2>&1 &
# nohup python run_nonorm_w_tuning.py --dataset_name='m4_weekly' --model_choice='feedforward' --ctx='gpu(1)' --n_trials=10 --batch_norm > nohup_out/current_gpu_ffn_batch_m4w1.out 2>&1 &
...
# nohup python run_nonorm_w_tuning.py --dataset_name='m4_weekly' --model_choice='deepar' --ctx='gpu(1)' --n_trials=5 --batch_norm > nohup_out/current_gpu_deepar_batch_m4w1.out 2>&1 &
