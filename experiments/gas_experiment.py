...
from experiments.normalizer_experiment import experiment_normalizer
from experiments.mean_layer_experiment import experiment_mean_layer
from experiments.dl_model_experiment import experiment_dl_model
...
def run_gas_experiment(
    ...
    (
        ...
        freq,
        n_features,
    ) = get_dataset_and_metadata(dataset_name, dataset_type)
    print("Done.")
